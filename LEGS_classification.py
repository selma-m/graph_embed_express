...
nci1_model = TSNet(in_channels, out_channels, trainable_laziness=False, trainable_f=True)
...
plt.savefig('nci1_legs_phate_plot.png', dpi=300) 
...
msrc9_model = TSNet(in_channels, out_channels, trainable_laziness=False, trainable_f=True)
...
plt.savefig('msrc9_legs_phate_plot.png', dpi=300) 
...
msrc21_model = TSNet(in_channels, out_channels, trainable_laziness=False, trainable_f=True)
...
plt.savefig('msrc21_legs_phate_plot.png', dpi=300) 
...
proteins_model = TSNet(in_channels, out_channels, trainable_laziness=False, trainable_f=True)
...
plt.savefig('proteins_legs_phate_plot.png', dpi=300) 
...
enzymes_model = TSNet(in_channels, out_channels, trainable_laziness=False, trainable_f=True)
...
plt.savefig('enzymes_legs_phate_plot.png', dpi=300) 
